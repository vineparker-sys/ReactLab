...
class ExportadorDados:
    """Exporta os dados coletados para um arquivo Excel, incluindo formatações e cálculos."""
    ...
    def exportar_para_excel(self):
        """Exporta os dados para um arquivo Excel, aplicando formatações e calculando o delta T."""
        ...
        # Determinar o caminho para a área de trabalho do usuário
        desktop_path = os.path.join(os.path.expanduser("~"), "Desktop")

        # Nome completo do arquivo a ser salvo na área de trabalho
        file_path = os.path.join(desktop_path, f"Amostra_{codigo_amostra}_{timestamp}.xlsx")

        try:
            # Exportar para Excel com XlsxWriter
